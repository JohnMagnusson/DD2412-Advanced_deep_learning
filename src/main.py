...
if do_fine_tune_model:
    ...
    model.load_weights("checkpoint_models/checkpoint_resnet-50")
    ...
    fine_tuned_model.save_weights("finetuned_models/checkpoint_resnet-50")
...
if do_evaluation_on_model:
    ...
    model = build_simCLR_model(encoder_network=encoder_network, projection_head_mode="nonlinear")
    model.load_weights("finetuned_models/checkpoint_resnet-50")
