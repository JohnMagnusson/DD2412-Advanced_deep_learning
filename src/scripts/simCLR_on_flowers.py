...
train_data, val_data, test_data = get_data_set("flowers")
...
if do_warmup_new_model:
    ...
    plot_loss(training_loss, validation_loss, should_save_figure=True, file_name="resnet_18_flowers_warmup_loss")
...
if do_train_new_model:
    ...
    plot_loss(training_loss, validation_loss, should_save_figure=True, file_name="resnet_18_flowers_training_loss")
...
if do_fine_tune_model:
    ...
    plot_fine_tuning(history_fine_tune, should_save_figure=True, file_name="resnet_18_flowers_fine_tuning")
...
if do_linear_evaluation:
    ...
    plot_linear_evaluation_accuracy(val_accuracy, should_save_figure=True, file_name="resnet_18_flowers_linear_evaluation")
