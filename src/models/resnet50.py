...
def block1(x, filters, kernel_size=3, stride=1, conv_shortcut=True, name=None, cifar_first_block=False):
    """A residual block.
    Arguments:
      x: input tensor.
    ...
    if (cifar_first_block):
        x = layers.Conv2D(filters, (3, 3), strides=1, name=name + '_1_conv')(x)
    else:
...
def ResNet50(include_top=True,
    ...
    return ResNet(stack_fn, False, True, 'resnet50', include_top, weights,
                  input_tensor, input_shape, pooling, classes, cifar=cifar, **kwargs)
